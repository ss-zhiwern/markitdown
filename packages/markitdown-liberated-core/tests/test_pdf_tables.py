...
class TestPdfTableExtraction:
    ...
    @pytest.fixture
    def markitdown_liberated(self):
        """Create MarkItDown instance."""
        return MarkItDown()

    def test_borderless_table_extraction(self, markitdown_liberated):
        ...
        result = markitdown_liberated.convert(pdf_path)
        text_content = result.text_content
    ...
    def test_borderless_table_no_duplication(self, markitdown_liberated):
    ...
    def test_borderless_table_correct_position(self, markitdown_liberated):
    ...
    def test_receipt_pdf_extraction(self, markitdown_liberated):
    ...
    def test_multipage_invoice_extraction(self, markitdown_liberated):
    ...
    def test_academic_pdf_extraction(self, markitdown_liberated):
    ...
    def test_scanned_pdf_handling(self, markitdown_liberated):
    ...
    def test_movie_theater_booking_pdf_extraction(self, markitdown_liberated):
...
class TestPdfFullOutputComparison:
    ...
    def test_movie_theater_full_output(self, markitdown_liberated):
    ...
    def test_sparse_borderless_table_full_output(self, markitdown_liberated):
    ...
    def test_repair_multipage_full_output(self, markitdown_liberated):
    ...
    def test_receipt_full_output(self, markitdown_liberated):
    ...
    def test_academic_paper_full_output(self, markitdown_liberated):
    ...
    def test_medical_scan_full_output(self, markitdown_liberated):
...
class TestPdfTableMarkdownFormat:
    ...
    def test_markdown_table_has_pipe_format(self, markitdown_liberated):
    ...
    def test_markdown_table_columns_have_pipes(self, markitdown_liberated):
...
class TestPdfTableStructureConsistency:
    ...
    def test_borderless_table_structure(self, markitdown_liberated):
    ...
    def test_multipage_invoice_table_structure(self, markitdown_liberated):
    ...
    def test_receipt_has_no_tables(self, markitdown_liberated):
    ...
    def test_scanned_pdf_no_tables(self, markitdown_liberated):
    ...
    def test_all_pdfs_table_rows_consistent(self, markitdown_liberated):
    ...
    def test_borderless_table_data_integrity(self, markitdown_liberated):
