...
def main():
    parser = argparse.ArgumentParser(
        ...
        prog="markitdown_liberated",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        usage=dedent(
            """
            SYNTAX:

                markitdown_liberated <OPTIONAL: FILENAME>
                If FILENAME is empty, markitdown_liberated reads from stdin.

            EXAMPLE:

                markitdown_liberated example.pdf

                OR

                cat example.pdf | markitdown_liberated
                ...
                markitdown_liberated example.pdf -o example.md

                OR

                markitdown_liberated example.pdf > example.md
            """
        ).strip(),
    )
    ...
    if args.filename is None:
        ...
        result = markitdown_liberated.convert(
